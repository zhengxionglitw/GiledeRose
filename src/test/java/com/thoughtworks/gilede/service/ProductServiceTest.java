...
public class ProductServiceTest {
    ...
    @Test
    public void backstage_pass_quality_rise_2() {
        ProductService productService = new ProductServiceImpl();
        String id = productService.addProduct(generateProduct(ProductType.BACKSTAGE_PASS, 10, 11));
        Product product = productService.reduceSellIn(id);
    ...
    @Test
    public void backstage_pass_quality_max_is_50() {
        ProductService productService = new ProductServiceImpl();
        String id = productService.addProduct(generateProduct(ProductType.BACKSTAGE_PASS, 49, 5));
        Product product = null;
        for (int i = 0; i < 4; i++) {
            product = productService.reduceSellIn(id);
        }
